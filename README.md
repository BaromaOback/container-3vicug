...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3vicug.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3vicug.containers.anotherwebservice.com/
...
```
git clone git@github.com:BaromaOback/container-3vicug.git
cd container-3vicug
```
...
```
docker attach container-3vicug
```
